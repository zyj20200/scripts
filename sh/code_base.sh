...
name_js=(
  Aaron-lv_sync_jd_scripts_jd_fruit
  Aaron-lv_sync_jd_scripts_jd_pet
  Aaron-lv_sync_jd_scripts_plantBean
  Aaron-lv_sync_jd_scripts_dreamFactory
  Aaron-lv_sync_jd_scripts_jdfactory
  Aaron-lv_sync_jd_scripts_jdzz
  Aaron-lv_sync_jd_scripts_crazy_joy
  Aaron-lv_sync_jd_scripts_jxnc
  Aaron-lv_sync_jd_scripts_bookshop
  Aaron-lv_sync_jd_scripts_cash
  Aaron-lv_sync_jd_scripts_sgmh
  Aaron-lv_sync_jd_scripts_cfd
  Aaron-lv_sync_jd_scripts_health
  Aaron-lv_sync_jd_scripts_moneyTree_heip
)
